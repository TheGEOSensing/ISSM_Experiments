...
%% Mesh parameters
domain = '/Users/rishi/Desktop/ISSM/examples/Pig/Stange_Antarctica.exp';
hinit=1000;	% element size for the initial mesh
hmax=3000;		% maximum element size of the final mesh
hmin=300;		% minimum element size of the final mesh
